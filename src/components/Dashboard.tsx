...
export default function Dashboard({ teacherId }: DashboardProps) {
  // ===== UI / nav =====
  const [activeTab, setActiveTab] = useState<"checker" | "results" | "excel">("checker");
                          ...
                          {isEditing ? (
                            <>
                              ...
                              <div style={{ display: "flex", gap: 8 }}>
                                <button className="primary-button" onClick={saveCourseName}>Save</button>
                                <button className="secondary-button" onClick={cancelEditCourse}>Cancel</button>
                              </div>
                            </>
                          ) : (
                            <>
